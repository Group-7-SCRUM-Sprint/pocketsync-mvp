...
const formatNGN = (amount: number, hidden: boolean) => {
  if (hidden) return "₦••••••••";
    ...
    <div className="balance-card">
      <div className="balance-card__header">
        ...
        <div className="balance-card__stat">
          <span className="balance-card__stat-label">This Month</span>
          <span className="balance-card__stat-value positive">
            <TrendUpIcon />
            {hidden ? "+₦••••••" : `+₦${monthlyChange.toLocaleString("en-NG")}.00`}
          </span>
        </div>

        <div className="balance-card__stat">
          <span className="balance-card__stat-label">Accounts</span>
          <span className="balance-card__stat-value accounts">{linkedAccounts} linked</span>
        </div>
      </div>

      <div className="balance-card__amount">
        {formatNGN(totalBalance, hidden)}
      </div>
